...
> 擴充功能可從 **Microsoft Edge 載入項目** 安裝（**v0.9.16 已過審**；**0.9.17** 請側載或等商店更新）；Chrome Web Store 提交中。**輔助應用程式需單獨下載**（見 [Releases](https://github.com/K-O-N-B/ChaiSniffer-Public/releases/latest)）。

**目前版本：** 擴充功能 **0.9.17** · 輔助應用程式 **host-v0.9.17** · [更新說明](RELEASE_NOTES/v0.9.17.md)
