...
> 扩展可从 **Microsoft Edge 加载项** 安装（**v0.9.16 已过审**；**0.9.17** 请侧载或等商店更新）；Chrome Web Store 提交中。**辅助应用需单独下载**（见 [Releases](https://github.com/K-O-N-B/ChaiSniffer-Public/releases/latest)）。

**当前版本：** 扩展 **0.9.17** · 辅助应用 **host-v0.9.17** · [更新说明](RELEASE_NOTES/v0.9.17.md)  
**Edge 商店：** 已通过（Partner Center 产品已上架/审核通过）
